...
this repo provides a reusable toolkit for building consistent, automated KiCad PCB outputs using KiBot and GitHub Actions. It is designed to be consumed as a Git submodule or dependency by KiCAD projects that require reproducible fabrication, assembly, and documentation pipelines.
...
```bash
git submodule add https://github.com/FutureProofHomes/kicad-pipeline-assets.git kicad-pipeline-assets
...
jobs:
  pcb:
    uses: FutureProofHomes/kicad-pipeline-assets/.github/workflows/reusable-kibot.yml@main
    with:
